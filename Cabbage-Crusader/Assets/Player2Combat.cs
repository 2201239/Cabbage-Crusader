...
public class Player2Combat : MonoBehaviour
{
    ...
    public static List<Player2Combat> enemyList = new List<Player2Combat>();


    public static List<Player2Combat> GetEnemyList()
    {
        return enemyList;
    }
    ...
    void PlayerAttack()
    {
        ...
        {
            enemy.GetComponent<Enemy1>().takeDMG(attackDMG);
        }
    }
